...
CREATE TABLE `press_info` (
  ...
  `press_site_ref` varchar(255),
  `press_print` varchar(255),
  `press_tv` varchar(255),
  `press_satellite` varchar(255),
  `press_online` varchar(255),
  `guest_prefix1` varchar(255),
  `guest_prefix_other1` varchar(255),
  `guest_name1` varchar(255),
  `guest_surname1` varchar(255),
  `guest_prefix2` varchar(255),
  `guest_prefix_other2` varchar(255),
  `guest_name2` varchar(255),
  `guest_surname2` varchar(255),
  `guest_prefix3` varchar(255),
  `guest_prefix_other3` varchar(255),
  `guest_name3` varchar(255),
  `guest_surname3` varchar(255),
